...
module.exports = function (context) {
    ...
    class JS_WshShell extends Component {
        ...
        get currentdirectory () {
            return context.config.environment.cwd;
        }
        ...
        set currentdirectory (new_cwd) {
            ...
            if (context.vfs.IsPathIllegal(new_cwd)) {
                context.exceptions.throw_generic_winapi_exception(
                    "Error",
                    "", // message
                    -2147024773,
                    "", // description
            ...
            if (typeof new_cwd !== "string" || ! context.vfs.FolderExists(new_cwd)) {
                context.exceptions.throw_generic_winapi_exception(
                    "WshShell",
            ...
            context.config.environment.cwd = new_cwd;
            return new_cwd;
        }
         ...
         */
        get environment () {
            return JS_WshEnvironment(context, "SYSTEM");
        }
         ...
         */
        get specialfolders () {
            return new JS_WshSpecialFolders(context, "WshShell");
        }
        ...
        createshortcut (pathname) {
            if (/\.(?:lnk|url)$/i.test(pathname) === false) {
                context.exceptions.throw_subscript_out_of_range(
                    "WshShell",
            ...
            //
            return new JS_WshShortcut(context, pathname);
        }
        ...
        exec (cmd) {
            ...
            return new JS_WshScriptExec(context);
        }
        ...
        expandenvironmentstrings (str) {
            ...
            const env_vars = Object.assign(
                {},
                context.config.environment.variables.system,
                context.config.environment.variables.user
            );
        ...
        logevent (log_type, message, host) {
            ...
            if (LOG_EVT_TYPES.hasOwnProperty(log_type) === false) {
                context.exceptions.throw_type_mismatch(
                    "WshShell",
        ...
        regdelete (regpath) {
            ...
            try {
                context.vreg.delete(regpath);
            }
            catch (e) {

                if (e.name === "VirtualRegistryUnknownSubkey") {
                    context.exceptions.throw_invalid_reg_root(
                        "WshShell",
        ...
        regread (regpath) {
            ...
            try {
                const regval = context.vreg.read(regpath);
                ...
                if (e.name === "VirtualRegistryInvalidRoot") {
                    ...
                    context.exceptions.throw_unknown_reg_subkey(
                        "WshShell",
