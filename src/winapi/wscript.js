...
function mock_Sleep (time) {
    console.log(`[WScript.Sleep] - Sleeping for ${time} seconds...`);
}
 ...
 *
 * Takes a strProgID - a string value indicating the programmatic
 * identifier (ProgID) of the object you wish to create.
 *                      
 */
function mock_CreateObject (type) {
    mock_MISSING_METHOD(`CreateObject: ${type}`);
}
